...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while temp_place.is_hive == False:
    ...
    def action(self, gamestate):
        ...
        while temp_place != None:
            if temp_place.ant != None:
                if temp_place.ant.is_container == True:
                    if temp_place.ant.ant_contained != None:
                        Ant.double(temp_place.ant)
                        Ant.double(temp_place.ant.ant_contained)
                    else:
                        Ant.double(temp_place.ant)
                else:
                    Ant.double(temp_place.ant)
