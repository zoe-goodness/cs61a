...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        temp_for_formals = formals
        temp_for_vals = vals
        while temp_for_formals is not nil:
            new_frame.define(temp_for_formals.first, temp_for_vals.first)
            temp_for_vals = temp_for_vals.rest
            temp_for_formals = temp_for_formals.rest
        return new_frame
        # END PROBLEM 8
